...
import type { HorizontalLocation, MenuItem, PaymentMethod, VerticalLocation } from "../../types/domain";
...
export default function CustomerOrder() {
  ...
  const deliveryFee = subtotal > 0 ? configuredDeliveryFee : 0;
